...
public:
    ...
    void setChatName(const QString chatName) {m_chatName = chatName;};
    ...
    void setDestinationName(const QString destinationName) {m_destinationName = destinationName;};

    /** The serverside (remotely set) name of the chat's destination, such as an MSN display name. */
    QString destinationDisplayName () const {return m_destinationDisplayName;}
    void setDestinationDisplayName(const QString destinationDisplayName) {m_destinationDisplayName = destinationDisplayName;}
    ...
    QUrl incomingIconPath() const { return m_incomingIconPath;};
    void setIncomingIconPath(const QUrl incomingIconPath) {m_incomingIconPath = incomingIconPath;};
    ...
    QUrl outgoingIconPath() const { return m_outgoingIconPath;};
    void setOutgoingIconPath(const QUrl outgoingIconPath) {m_outgoingIconPath = outgoingIconPath;};

    /** The time at which the chat was opened. */
    QDateTime timeOpened() const { return m_timeOpened;};
    void setTimeOpened( const QDateTime timeOpened ) {m_timeOpened = timeOpened;};
